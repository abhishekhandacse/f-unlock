...
subjects = ["", "Abhishek Handa", "Ajay Jindal","Aman Kataria","Navneet","Abhishek Salwan"]
...
test_img_paths = os.listdir(test_data_path)
...
for test_img_path in test_img_paths:
	...
	try:
		...
		print(test_img_path)
		test_img = cv2.imread(test_data_path+'/'+test_img_path)
		...
		label = test_img_path[-5]
		cv2.imshow(test_img_path, cv2.resize(predicted_img, (400, 500)))
